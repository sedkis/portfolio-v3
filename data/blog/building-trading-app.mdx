...
More technically speaking - Do you need a database, APIs, a place to run software? Literally thousands loads of options. I've already
talked about how [available this is][0].

I have no affiliation with any of the vendors mentioned below, except as a user, at the time of publishing.

Let's take an interesting example - You've decided (that despite the current economic temperature,) you want to build a trading platform.

Here are some tricky things you need to worry about:
