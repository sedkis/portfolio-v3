...
This piece is both a warning to architects considering AWS Appync as well an actual how-to of how to implement unauthenticated access, skip down to the actual guide
...
[1]: https://the dude's link to AWS Appsync ssubscriptions not working cuz stupid ass headers
